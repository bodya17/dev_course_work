...
(function() {
  define('plot',[], function() {
    return {
      plot: function() {
        var i, results, trace1, trace2, x, y;
        x = (function() {
          results = [];
          for (i = -1000; i <= 1000; i++){ results.push(i); }
          return results;
      ...
      fromArrs: function(x, y, x_approx, y_approx, approx, max_err_line) {
...
(function() {
  define('server',[], function() {
    return {
      ask: function(what, body, cb) {
        return fetch("https://simple-flask-bla.herokuapp.com/" + what, {
          method: 'POST',
          body: body
        }).then(function(res) {
          return res.json();
...
(function() {
  define('main',['plot', 'server'], function(plot, server) {
    var btnFind, els, getParams, populateForm, pushParams;
    els = {
    ...
    btnFind.addEventListener('click', function(e) {
      ...
      return server.ask('least_squares', els.func.value + "|" + els.deg.value + "|" + els.start.value + "|" + els.end.value + "|" + els.points_ctn.value, function(res) {
        var removeDigits;
        ...
        return plot.fromArrs(res.x_vals, res.y_vals, res.x_approx, res.f_x_approx, res.approximation, res.max_error_line);
      });
    });
    getParams = function() {
      return JSON.parse(localStorage.getItem('params'));
    };
    pushParams = function(obj) {
      return localStorage.setItem('params', JSON.stringify(obj));
    };
    return populateForm = function() {
      var params;
      params = getParams();
      ...
      return els.after_point.value = params.after_point;
    };
  });
